...
document.addEventListener('DOMContentLoaded', function () {
    ...
    showProduct(currentIndex); // initial show
    ...
    // 💡 Add event listeners to "Explore Our Fleet" and "Contact Sales" buttons
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Smooth scroll for "Explore Our Fleet" button
        const exploreBtn = document.querySelector(".explore-btn") || document.getElementById("explore-btn");
        const fleetSection = document.querySelector("#fleet-section");
      
        if (exploreBtn && fleetSection) {
        ...
        // Smooth scroll for "Contact Sales" button
        const contactBtn = document.querySelector(".contact-btn") || document.getElementById("contact-btn");
